...
export function RadiusMap() {
  return (
    ...
    >
      ...
      {/* Base: Denver PA */}
      <circle cx="320" cy="240" r="16" fill="none" stroke="#c9d64f" strokeWidth="1" opacity="0.6" className="map-pulse" />
      <circle cx="320" cy="240" r="5.5" fill="#c9d64f" />
      ...
      {CITIES.map((c) => (
        <a key={c.slug} href={`/service-areas/${c.slug}`} className="group/city">
          <circle
            ...
            r="4"
            fill="#2274ce"
            className="transition-all group-hover/city:fill-[#c9d64f]"
          />
